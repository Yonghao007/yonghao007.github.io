...
export default function ExperiencePage() {
  return (
    <PageShell
      ...
      intro="Internship responsibilities, technical work, and hands-on development experience."
    >
        ...
        <div className="rounded-[2rem] border border-sky-200/70 bg-white/75 p-8 shadow-lg shadow-sky-100">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-1 text-base font-medium text-slate-700">Fuzhou Amigo Software Co., Ltd.</p>
            </div>
